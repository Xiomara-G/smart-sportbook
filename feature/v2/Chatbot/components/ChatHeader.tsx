...
export const ChatHeader = memo(function ChatHeader({ onNewChat }: ChatHeaderProps) {
  ...
  return (
    <>
      <header className="sticky top-0 z-10 border-b border-gray-800 bg-gray-900/80 px-4 py-3 backdrop-blur-md">
      ...
      {showHelp && (
        ...
        >
          <div
            className="mx-4 max-w-sm rounded-xl bg-gray-800 p-6 shadow-lg"
